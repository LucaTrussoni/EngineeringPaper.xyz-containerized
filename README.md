...
The playwright workflow has been removed in this fork to avoid unnecessary CI runs.
The docker-build workflow has been added to create image in the github registry.
